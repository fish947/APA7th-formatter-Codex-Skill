...
│   └── statistics.md            统计数据与公式处理边界
├── scripts/
│   ├── apa7_format.py           Word 排版与保存后核验
│   ├── apa7_statistics.py       统计表达、数据汇报与公式检查
...
APA 官方原文包括： “Report exact p values to two or three decimals”；“Number all displayed equations consecutively”；投稿透明度要求还列出 “Exact p values, effect sizes, and 95% confidence intervals”。完整上下文和例外见上面的官方链接。
...
│   └── statistics.md            Statistical-reporting and equation boundaries
├── scripts/
│   ├── apa7_format.py           Word formatting and post-save verification
│   ├── apa7_statistics.py       Statistical expressions, result reporting, and equation checks
...
Key APA wording includes “Report exact p values to two or three decimals,” “Number all displayed equations consecutively,” and, for reporting transparency, “Exact p values, effect sizes, and 95% confidence intervals.” Follow the official links above for the full context and exceptions.
